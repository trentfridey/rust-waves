...
exports.Canvas = exports.__wbindgen_throw = exports.__wbindgen_object_drop_ref = exports.__wbg_error_4bb6c2a97407129a = exports.__wbg_stack_558ba5917b466edd = exports.__wbg_new_59cb74e423758ede = exports.default = void 0;

var _wave_equation_bg = _interopRequireDefault(require("./pkg/wave_equation_bg.wasm"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = _wave_equation_bg.default;
exports.default = _default;
var __wbg_new_59cb74e423758ede = _wave_equation_bg.default.__wbg_new_59cb74e423758ede;
exports.__wbg_new_59cb74e423758ede = __wbg_new_59cb74e423758ede;
var __wbg_stack_558ba5917b466edd = _wave_equation_bg.default.__wbg_stack_558ba5917b466edd;
exports.__wbg_stack_558ba5917b466edd = __wbg_stack_558ba5917b466edd;
var __wbg_error_4bb6c2a97407129a = _wave_equation_bg.default.__wbg_error_4bb6c2a97407129a;
exports.__wbg_error_4bb6c2a97407129a = __wbg_error_4bb6c2a97407129a;
var __wbindgen_object_drop_ref = _wave_equation_bg.default.__wbindgen_object_drop_ref;
exports.__wbindgen_object_drop_ref = __wbindgen_object_drop_ref;
var __wbindgen_throw = _wave_equation_bg.default.__wbindgen_throw;
exports.__wbindgen_throw = __wbindgen_throw;
var Canvas = _wave_equation_bg.default.Canvas;
exports.Canvas = Canvas;
},{"./pkg/wave_equation_bg.wasm":"crate/pkg/wave_equation_bg.wasm"}],"js/index.js":[function(require,module,exports) {
"use strict";

var _Cargo = _interopRequireWildcard(require("../crate/Cargo.toml"));
...
var rustCanvas = _Cargo.Canvas.new(canvas.width, canvas.height);

var width = rustCanvas.width();
var height = rustCanvas.height();
var ctx = canvas.getContext('2d');
var stepBtn = document.getElementById('step-btn');
stepBtn.addEventListener('click', step); // Debug tools --------------------------------------------

var FPSCounter = document.getElementById('fps');
var frameCounter = document.getElementById('frameCount');

var debug = function debug() {} // let debugCanvas = document.getElementById('test-coloring');
...
function pick(event, destination) {
  ...
  var _data = _slicedToArray(data, 4),
      ...
      g = _data[1],
      b = _data[2],
      a = _data[3]; // console.log(event)


  var rgba_to_hue = function rgba_to_hue(args) {
    var normalize = function normalize(v) {
      return v / 255;
    };

    var normalized = Array.from(args).map(function (v) {
      return normalize(v);
    });
    var xMax = Math.max.apply(Math, _toConsumableArray(normalized));
    var xMin = Math.min.apply(Math, _toConsumableArray(normalized));

    var _normalized = _slicedToArray(normalized, 3),
        r = _normalized[0],
        g = _normalized[1],
        b = _normalized[2];
  ...
  var rgba = "rgba(".concat(r, ", ").concat(g, ", ").concat(b, ", ").concat(a / 255, ")");
  destination.style.background = rgba;
  destination.textContent = "".concat(rgba_to_hue(data.slice(0, 3)).toFixed(0), " degrees");
  return rgba;
}
...
function step() {
  ...
  frameCount++;
  frameCounter.innerText = frameCount; // norm.innerText = rustCanvas.norm();

  var imagePtr = rustCanvas.image();
  var imageArray = new Uint8ClampedArray(_Cargo.default.wasm.memory.buffer, imagePtr, 4 * height * width);
  var imageData = new ImageData(imageArray, width, height);
...
var b=require("node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("wasm",require("node_modules/parcel-plugin-wasm.rs/wasm-loader.js"));b.load([["wave_equation_bg.85c83af7.wasm","crate/pkg/wave_equation_bg.wasm"]]).then(function(){require("js/index.js");});
